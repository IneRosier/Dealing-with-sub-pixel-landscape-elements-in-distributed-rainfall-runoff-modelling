...
#adapted_withculverts 5m/ 10m/ 20m
...
class OverlandFlow(Component):
    ...
    **Additional References**
    ...
    _info = {
        ...
        "mannings_n__coefficients": {
            "dtype": float,
            "intent": "in",
            "optional": False,
            "units": "-",
            "mapping": "node",
            "doc": "mannings n coefficient",
        },
    ...
    def __init__(
        ...
        culvert_links : list of int
            Give node IDs of culvert links.
        """
        super().__init__(grid)
        ...
        #     self._mannings_n = grid.at_node[mannings_n]
        #     self._mannings_n = self._grid.map_mean_of_link_nodes_to_link(self._mannings_n)
...
################################################################################  
        # For manning n at links
        try:
            self._manning_links = grid.add_zeros(
                "mannings_n__coefficients",
                at="link",
                units=self._info["mannings_n__coefficients"]["units"],
            )
        except FieldError:
            self._manning_links = grid.at_link["mannings_n__coefficients"]
            self._manning_links.fill(0.0)
        

        self._manning = grid.at_node["mannings_n__coefficients"]
...
##################################################################################
    @property
    def manning(self):
        """The manning n coefficient at each node."""
...
##################################################################################
    ...
    def overland_flow(self, culvert_links, dt=None):
        ...
        while local_elapsed_time < dt:
            ...
            manning_mean = self._grid.map_mean_of_link_nodes_to_link(self._manning)
            manning_mean2 = manning_mean[self._grid.active_links]
            w = self._h + self._z
...
################################################################################
            self._manning_links[self._active_links] = manning_mean2
################################################################################
            ...
            try:
                ...
                self._q[vert] = (
                    ...
                    * self._water_surface_slope[vert]
                    ...
                    + self._g
                    * self._dt
                    * self._manning_links[vert] ** 2.0
                    * abs(self._q[vert])
                    / self._h_links[vert] ** _SEVEN_OVER_THREE
                )

            except ValueError:
                self._manning_links = self._grid["link"]["mannings_n__coefficients"]
            ...
            i = 0
            while i < len(culvert_links):
                self._q[culvert_links[i]]=0
                i = i + 1
            ...
            if self._grid.dx == 10:
        ############ culvert 1
                elev_culvert = 0.409834
                diam_culvert = 0.20
                slope_culvert = 0.0334140300063132
                r_culvert = diam_culvert/2
                h_culvert = self._h[58255] 
                z_culvert = self._z[58255]
                mannings_n_culvert = 0.0328 #chow 1959 concrete culvert free from debris
                
                if (z_culvert + h_culvert >= z_culvert + elev_culvert + diam_culvert):
                    flowregime = "orifice"
                    hydr_head = h_culvert - elev_culvert - r_culvert
                    q_vol_culvert = 0.62 * math.pi * r_culvert**2 * math.sqrt(2 * scipy.constants.g *  hydr_head ) 
                    q_culvert1 = q_vol_culvert / self._grid.dx
                    
                if ((z_culvert + h_culvert < z_culvert + elev_culvert + diam_culvert) and (z_culvert + h_culvert >= z_culvert + elev_culvert + (diam_culvert/2))):
                    flowregime = "more_than_half_full"
                    head = elev_culvert + diam_culvert - h_culvert
                    theta_culvert = 2 * math.acos((r_culvert - head)/r_culvert)
                    area = math.pi * r_culvert**2 - ((r_culvert**2 * (theta_culvert - math.sin(theta_culvert)))/2)
                    perim_wet = 2 * math.pi * r_culvert - r_culvert * theta_culvert
                    r_hydr = area / perim_wet
                    q_vol_culvert = (1/mannings_n_culvert) * area * (r_hydr**(2/3)) * (slope_culvert**(1/2))
                    q_culvert1 = q_vol_culvert / self._grid.dx
                    
                if ((z_culvert + h_culvert < z_culvert + elev_culvert + (diam_culvert/2)) and (z_culvert + h_culvert >= z_culvert + elev_culvert)):
                    flowregime = "less_than_half_full"
                    head = h_culvert - elev_culvert
                    theta_culvert = 2 * math.acos((r_culvert - head)/r_culvert)
                    area = ((r_culvert**2 * (theta_culvert - math.sin(theta_culvert)))/2)  
                    perim_wet = r_culvert * theta_culvert
                    r_hydr = area / perim_wet
                    q_vol_culvert = (1/mannings_n_culvert) * area * (r_hydr**(2/3)) * (slope_culvert**(1/2))
                    q_culvert1 = q_vol_culvert / self._grid.dx
                    
                if (z_culvert + h_culvert < z_culvert + elev_culvert):
                    flowregime = 0
                    q_culvert1 = 0
                
                self._q[116229] = self._q[116229] + q_culvert1
                self._q[116432] = self._q[116432] + q_culvert1
    ...
    ############ culvert 2
                ...
                slope_culvert = 0.005
                r_culvert = diam_culvert/2
                h_culvert = self._h[58256] 
                z_culvert = self._z[58256]
                mannings_n_culvert = 0.0328 #chow 1959 concrete culvert free from debris
                ...
                if (z_culvert + h_culvert >= z_culvert + elev_culvert + diam_culvert):
                    ...
                    hydr_head = h_culvert - elev_culvert - r_culvert
                    q_vol_culvert = 0.62 * math.pi * r_culvert**2 * math.sqrt(2 * scipy.constants.g *  hydr_head ) 
                    q_culvert2 = q_vol_culvert / self._grid.dx
                ...
                self._q[116230] = self._q[116230] + q_culvert2
                
    ############ culvert 3
                elev_culvert = 0
                diam_culvert = 0.25
                slope_culvert = 0.017144115
                r_culvert = diam_culvert/2
                h_culvert = self._h[49502] 
                z_culvert = self._z[49502]
                mannings_n_culvert = 0.0328 #chow 1959 concrete culvert free from debris
                ...
                if (z_culvert + h_culvert >= z_culvert + elev_culvert + diam_culvert):
                    ...
                    hydr_head = h_culvert - elev_culvert - r_culvert
                    q_vol_culvert = 0.62 * math.pi * r_culvert**2 * math.sqrt(2 * scipy.constants.g *  hydr_head ) 
                    q_culvert3 = q_vol_culvert / self._grid.dx
                ...
                self._q[98790] = self._q[98790] + q_culvert3
                self._q[99195] = self._q[99195] + q_culvert3
                    
                    
    ############ culvert 4
                elev_culvert = 0.703952
                diam_culvert = 0.20
                slope_culvert = 0.053794875
                r_culvert = diam_culvert/2
                h_culvert = self._h[49502] 
                z_culvert = self._z[49502]
                mannings_n_culvert = 0.0328 #chow 1959 concrete culvert free from debris
                ...
                if (z_culvert + h_culvert >= z_culvert + elev_culvert + diam_culvert):
                    ...
                    hydr_head = h_culvert - elev_culvert - r_culvert
                    q_vol_culvert = 0.62 * math.pi * r_culvert**2 * math.sqrt(2 * scipy.constants.g *  hydr_head ) 
                    q_culvert4 = q_vol_culvert / self._grid.dx
                ...
                if (z_culvert + h_culvert < z_culvert + elev_culvert):
                    flowregime = 0
                    q_culvert4 = 0
                self._q[98790] = self._q[98790] + q_culvert4
                self._q[99195] = self._q[99195] + q_culvert4            
                    
    ############ culvert 5
                elev_culvert = 0.250201
                diam_culvert = 0.25
                slope_culvert = 0.007310257
                r_culvert = diam_culvert/2
                h_culvert = self._h[46652] 
                z_culvert = self._z[46652]
                mannings_n_culvert = 0.0328 #chow 1959 concrete culvert free from debris
                ...
                if (z_culvert + h_culvert >= z_culvert + elev_culvert + diam_culvert):
                    ...
                    hydr_head = h_culvert - elev_culvert - r_culvert
                    q_vol_culvert = 0.62 * math.pi * r_culvert**2 * math.sqrt(2 * scipy.constants.g *  hydr_head ) 
                    q_culvert5 = q_vol_culvert / self._grid.dx
                ...
                if (z_culvert + h_culvert < z_culvert + elev_culvert):
                    flowregime = 0
                    q_culvert5 = 0
                self._q[93112] = self._q[93112] + q_culvert5
                self._q[93315] = self._q[93315] + q_culvert5    
     
    ############ culvert 6
                elev_culvert = 0.573448
                diam_culvert = 0.20
                slope_culvert = 0.005558142
                r_culvert = diam_culvert/2
                h_culvert = self._h[46652] 
                z_culvert = self._z[46652]
                mannings_n_culvert = 0.0328 #chow 1959 concrete culvert free from debris
                ...
                if (z_culvert + h_culvert >= z_culvert + elev_culvert + diam_culvert):
                    ...
                    hydr_head = h_culvert - elev_culvert - r_culvert
                    q_vol_culvert = 0.62 * math.pi * r_culvert**2 * math.sqrt(2 * scipy.constants.g *  hydr_head ) 
                    q_culvert6 = q_vol_culvert / self._grid.dx
                ...
                if (z_culvert + h_culvert < z_culvert + elev_culvert):
                    flowregime = 0
                    q_culvert6 = 0
                self._q[93112] = self._q[93112] + q_culvert6
                self._q[93315] = self._q[93315] + q_culvert6                
                    
    ############ culvert 7
                elev_culvert = 0
                width_culvert = 0.91
                slope_culvert = 0.016398168
                h_culvert = self._h[39934] 
                z_culvert = self._z[39934]
                mannings_n_culvert = 0.0328 #chow 1959 concrete culvert free from debris
                
                area = width_culvert * h_culvert
                perim_wet = 2 * h_culvert + width_culvert
                r_hydr = area / perim_wet
                q_vol_culvert = (1/mannings_n_culvert) * area * (r_hydr**(2/3)) * (slope_culvert**(1/2))
                q_culvert7 = q_vol_culvert / self._grid.dx
                self._q[80133] = self._q[80133] + q_culvert7
                self._q[80336] = self._q[80336] + q_culvert7               
    ...
    ############ culvert 8
                ...
                slope_culvert = 0.005
                r_culvert = diam_culvert/2
                h_culvert = self._h[29557] 
                z_culvert = self._z[29557]
                mannings_n_culvert = 0.0328 #chow 1959 concrete culvert free from debris
                ...
                if (z_culvert + h_culvert >= z_culvert + elev_culvert + diam_culvert):
                    ...
                    hydr_head = h_culvert - elev_culvert - r_culvert
                    q_vol_culvert = 0.62 * math.pi * r_culvert**2 * math.sqrt(2 * scipy.constants.g *  hydr_head ) 
                    q_culvert8 = q_vol_culvert / self._grid.dx
                ...
                if (z_culvert + h_culvert < z_culvert + elev_culvert):
                    flowregime = 0
                    q_culvert8 = 0
                self._q[59454] = self._q[59454] + q_culvert8
                    
    ############ culvert 9
                elev_culvert = 0
                width_culvert = 1.36
                height_culvert = 0.70
                slope_culvert = 0.067465704
                h_culvert = self._h[28336] 
                z_culvert = self._z[28336]
                mannings_n_culvert = 0.0328 #chow 1959 concrete culvert free from debris
                
                if (z_culvert + h_culvert >= z_culvert + elev_culvert + height_culvert):
                    flowregime = "orifice"
                    hydr_head = h_culvert - elev_culvert - height_culvert/2
                    q_vol_culvert = 0.62 * width_culvert*height_culvert * math.sqrt(2 * scipy.constants.g *  hydr_head ) 
                    q_culvert9 = q_vol_culvert / self._grid.dx
                ...
                self._q[56616] = self._q[56616] + q_culvert9
                self._q[56819] = self._q[56819] + q_culvert9  
                self._q[57022] = self._q[57022] + q_culvert9
            if self._grid.dx == 5:
    ############ culvert 1
                elev_culvert = 0.409834
                diam_culvert = 0.20
                slope_culvert = 0.0334140300063132
                r_culvert = diam_culvert/2
                h_culvert = self._h[232056] 
                z_culvert = self._z[232056]
                mannings_n_culvert = 0.0328 #chow 1959 concrete culvert free from debris
                ...
                self._q[463548] = self._q[463548] + q_culvert1
                self._q[464357] = self._q[464357] + q_culvert1
    ...
    ############ culvert 2
                ...
                self._q[463548] = self._q[463548] + q_culvert2
                self._q[464357] = self._q[464357] + q_culvert2              
    ############ culvert 3
                elev_culvert = 0
                diam_culvert = 0.25
                slope_culvert = 0.017144115
                r_culvert = diam_culvert/2
                h_culvert = self._h[197581] 
                z_culvert = self._z[197581]
                mannings_n_culvert = 0.0328 #chow 1959 concrete culvert free from debris
                ...
                self._q[394733] = self._q[394733] + q_culvert3
                self._q[395138] = self._q[395138] + q_culvert3
    ...
    ############ culvert 4
                ...
                if (z_culvert + h_culvert < z_culvert + elev_culvert):
                    flowregime = 0
                    q_culvert4 = 0
                self._q[394733] = self._q[394733] + q_culvert4
                self._q[395138] = self._q[395138] + q_culvert4            
    ...
    ############ culvert 5
                ...
                slope_culvert = 0.007310257
                r_culvert = diam_culvert/2
                h_culvert = self._h[185416] 
                z_culvert = self._z[185416]
                mannings_n_culvert = 0.0328 #chow 1959 concrete culvert free from debris
                ...
                if (z_culvert + h_culvert < z_culvert + elev_culvert):
                    flowregime = 0
                    q_culvert5 = 0
                self._q[370448] = self._q[370448] + q_culvert5
                self._q[371257] = self._q[371257] + q_culvert5    
    ...
    ############ culvert 6
                ...
                if (z_culvert + h_culvert < z_culvert + elev_culvert):
                    flowregime = 0
                    q_culvert6 = 0
                self._q[370448] = self._q[370448] + q_culvert6
                self._q[371257] = self._q[371257] + q_culvert6                
                    
    ############ culvert 7
                elev_culvert = 0
                width_culvert = 0.91
                slope_culvert = 0.016398168
                h_culvert = self._h[159862] 
                z_culvert = self._z[159862]
                mannings_n_culvert = 0.0328 #chow 1959 concrete culvert free from debris
                ...
                q_vol_culvert = (1/mannings_n_culvert) * area * (r_hydr**(2/3)) * (slope_culvert**(1/2))
                q_culvert7 = q_vol_culvert / self._grid.dx
                self._q[319038] = self._q[319038] + q_culvert7
                self._q[319443] = self._q[319443] + q_culvert7               
    ...
    ############ culvert 8
                ...
                slope_culvert = 0.005
                r_culvert = diam_culvert/2
                h_culvert = self._h[118100] 
                z_culvert = self._z[118100]
                mannings_n_culvert = 0.0328 #chow 1959 concrete culvert free from debris
                ...
                if (z_culvert + h_culvert < z_culvert + elev_culvert):
                    flowregime = 0
                    q_culvert8 = 0
                #self._q[236472] = self._q[236472] + q_culvert8
                self._q[236068] = self._q[236068] + q_culvert8                
    ...
    ############ culvert 9
                ...
                height_culvert = 0.70
                slope_culvert = 0.067465704
                h_culvert = self._h[113234] 
                z_culvert = self._z[113234]
                mannings_n_culvert = 0.0328 #chow 1959 concrete culvert free from debris
                ...
                self._q[226354] = self._q[226354] + q_culvert9
                self._q[226759] = self._q[226759] + q_culvert9  
                self._q[227164] = self._q[227164] + q_culvert9
        ...
        ############ culvert 1
                ...
                slope_culvert = 0.0334140300063132
                r_culvert = diam_culvert/2
                h_culvert = self._h[14684] 
                z_culvert = self._z[14684]
                mannings_n_culvert = 0.0328 #chow 1959 concrete culvert free from debris
                ...
                self._q[29127] = self._q[29127] + q_culvert1
    ...
    ############ culvert 2
                ...
                slope_culvert = 0.005
                r_culvert = diam_culvert/2
                h_culvert = self._h[14583] 
                z_culvert = self._z[14583]
                mannings_n_culvert = 0.0328 #chow 1959 concrete culvert free from debris
                ...
                self._q[29026] = self._q[29026] + q_culvert2
    ...
    ############ culvert 3
                ...
                slope_culvert = 0.017144115
                r_culvert = diam_culvert/2
                h_culvert = self._h[12428] 
                z_culvert = self._z[12428]
                mannings_n_culvert = 0.0328 #chow 1959 concrete culvert free from debris
                ...
                self._q[24750] = self._q[24750] + q_culvert3
                self._q[24953] = self._q[24953] + q_culvert3
    ...
    ############ culvert 4
                ...
                if (z_culvert + h_culvert < z_culvert + elev_culvert):
                    flowregime = 0
                    q_culvert4 = 0
                self._q[24750] = self._q[24750] + q_culvert4
                self._q[24953] = self._q[24953] + q_culvert4            
    ...
    ############ culvert 5
                ...
                slope_culvert = 0.007310257
                r_culvert = diam_culvert/2
                h_culvert = self._h[11710] 
                z_culvert = self._z[11710]
                mannings_n_culvert = 0.0328 #chow 1959 concrete culvert free from debris
                ...
                if (z_culvert + h_culvert < z_culvert + elev_culvert):
                    flowregime = 0
                    q_culvert5 = 0
                self._q[23325] = self._q[23325] + q_culvert5
    ...
    ############ culvert 6
                ...
                if (z_culvert + h_culvert < z_culvert + elev_culvert):
                    flowregime = 0
                    q_culvert6 = 0
                self._q[23325] = self._q[23325] + q_culvert6
    ...
    ############ culvert 7
                ...
                width_culvert = 0.91
                slope_culvert = 0.016398168
                h_culvert = self._h[10069] 
                z_culvert = self._z[10069]
                mannings_n_culvert = 0.0328 #chow 1959 concrete culvert free from debris
                ...
                q_vol_culvert = (1/mannings_n_culvert) * area * (r_hydr**(2/3)) * (slope_culvert**(1/2))
                q_culvert7 = q_vol_culvert / self._grid.dx
                self._q[20068] = self._q[20068] + q_culvert7
    ...
    ############ culvert 8
                ...
                slope_culvert = 0.005
                r_culvert = diam_culvert/2
                h_culvert = self._h[7405] 
                z_culvert = self._z[7405]
                mannings_n_culvert = 0.0328 #chow 1959 concrete culvert free from debris
                ...
                if (z_culvert + h_culvert < z_culvert + elev_culvert):
                    flowregime = 0
                    q_culvert8 = 0
                self._q[14778] = self._q[14778] + q_culvert8
    ...
    ############ culvert 9
                ...
                height_culvert = 0.70
                slope_culvert = 0.067465704
                h_culvert = self._h[7098] 
                z_culvert = self._z[7098]
                mannings_n_culvert = 0.0328 #chow 1959 concrete culvert free from debris
                ...
                self._q[14168] = self._q[14168] + q_culvert9
